...
const SignUp = () => {
    return (
        <div className="w-full mx-auto   p-4 rounded-md shadow sm:p-8 dark:bg-gray-50 dark:text-gray-800">
            ...
            <p className="block mt-1 font-sans text-center text-base antialiased font-normal leading-relaxed text-gray-700">
            ...
            {/*    ----------- */}
            <p className="text-sm text-center mt-4 dark:text-gray-600">Already have an account?
